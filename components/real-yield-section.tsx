        ...
        <div className="flex flex-col items-center gap-10 md:flex-row md:items-center md:gap-16">
          ...
          <div className="flex-1">
            ...
            <p className="mt-6 text-base leading-relaxed text-blue-200">
              STRATO&apos;s yield comes from real economic activity generated by our automated arbitrage vault, not from
              emissions. Deposit into the vault and an autonomous bot trades on your behalf, buying low and selling
              high, continuously correcting prices across gold, silver, ETH, BTC, and stablecoin pools. Even while you
              sleep.
            </p>
            <a
