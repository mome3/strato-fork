...
[Download the full CPA audit report (PDF)](/blog/ba-gold-vault-audit-dec-2025.pdf)
...
[Download the BA Gold vaulting letter (PDF)](/blog/blockapps-vaulting-letter-march-2026.pdf)
...
At STRATO, "Verify Everything" isn't just a tagline. Both documents are available for download above so you can review them yourself. You can also track on-chain metal token supplies in real time on [STRATO Scan](https://stratoscan.strato.nexus/).

Ready to start collecting tokenized gold and silver? Head to [STRATO](https://app.strato.nexus/) to get started, or join the conversation on [Telegram](https://t.me/strato_net).
