...
date: 2026-03-12
hosts: ["Victor Wong"]
guests: ["Jeffry Powell", "Michael Tan", "Kieren James-Lubin"]
description: "Discussion with [Victor Wong](/people/victor-wong), [Jeffry Powell](/people/jeffry-powell), [Michael Tan](/people/michael-tan), and [Kieren James-Lubin](/people/kieren-james-lubin) on crypto credit cards, DeFi lending, and the future of everyday crypto spending. The team demos the new [STRATO](https://strato.nexus)–MetaMask card integration that turns a crypto debit card into a true credit card, discusses why DeFi initially missed credit as a use case, explores reputation-based unsecured lending, and debates whether crypto rails will eventually replace traditional payment infrastructure."
img: /images/covers-for-spaces/online-oracles-everyday-crypto-spending-and-crypto-credit-cards.png
embed:
  url: https://www.youtube.com/embed/pbmujx5TcEk
table_of_contents:
  - link: "#introductions-and-metamask-card-demo"
    title: "Introductions and MetaMask card demo"
  - link: "#why-defi-got-credit-wrong"
    title: "Why DeFi got credit wrong"
  - link: "#crypto-rails-and-the-agentic-future"
    title: "Crypto rails and the agentic future"
  - link: "#defi-credit-liquidations-and-reputation"
    title: "DeFi credit, liquidations, and reputation"
  - link: "#the-future-of-crypto-credit-cards"
    title: "The future of crypto credit cards"
